...
export function dateInTimezone(date: Date = new Date(), timezone = getLocalTimeZone()): LocalDateString {
...
export function todayInTimezone(timezone = getLocalTimeZone()): LocalDateString {
  return dateInTimezone(new Date(), timezone);
}

export function todayInShanghai(): LocalDateString {
  return todayInTimezone("Asia/Shanghai");
}
